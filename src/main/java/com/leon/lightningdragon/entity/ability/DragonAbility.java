...
import com.leon.lightningdragon.entity.ability.DragonAbilitySection.*;
...
public abstract class DragonAbility<T extends LivingEntity> {
    ...
    private final DragonAbilityType<T, ? extends DragonAbility> abilityType;
    ...
    public DragonAbility(DragonAbilityType<T, ? extends DragonAbility> abilityType, T user, 
    ...
    public void playAnimation(RawAnimation animation) {
        if (getUser() instanceof GeoEntity && getUser().level().isClientSide()) {
            activeAnimation = animation;
            // Dragon-specific animation controller integration will go here
            if (user instanceof DragonAbilityEntity) {
    ...
    public DragonAbilityType<T, ? extends DragonAbility> getAbilityType() {
        return abilityType;
    }
