...
public class DragonFlightController {
    ...
    public void planSmartLanding() {
        ...
        plannedLandingPos = findSafeLandingSpot(center, 10);
    ...
    private net.minecraft.core.BlockPos findSafeLandingSpot(net.minecraft.core.BlockPos center, int radius) {
    ...
    private void handleServerFlightLogic() {
        ...
        // Nudge toward planned landing if any
        if (dragon.stateManager.isLanding() && plannedLandingPos != null) {
            // Refresh target in case navigation has stopped
    ...
    private void applyHoverStabilizer() {
        ...
        boolean hoveringLike = dragon.stateManager.isHovering() || dragon.stateManager.isTakeoff() || dragon.isBeaming();
