...
public class LightningBeamAbility extends DragonAbility<LightningDragonEntity> {
    ...
    protected void beginSection(DragonAbilitySection section) {
        ...
        if (section.sectionType == AbilitySectionType.STARTUP) {
            ...
            getUser().triggerAnim("action", "animation.lightning_dragon.beam_start");
            ...
            getUser().triggerAnim("action", "animation.lightning_dragon.lightning_beam");
        }
    }
    ...
    protected void endSection(DragonAbilitySection section) {
        ...
        if (section != null && section.sectionType == AbilitySectionType.ACTIVE) {
            ...
            getUser().triggerAnim("action", "animation.lightning_dragon.beam_end");
        }
    }
