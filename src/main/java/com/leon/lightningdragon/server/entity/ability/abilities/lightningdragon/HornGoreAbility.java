...
public class HornGoreAbility extends DragonAbility<LightningDragonEntity> {
        ...
        if (section.sectionType == AbilitySectionType.STARTUP) {
            ...
            if (!playedSoundThisUse && !getLevel().isClientSide) {
                ...
                getLevel().playSound(
                        ...
                        com.leon.lightningdragon.common.registry.ModSounds.DRAGON_HORNGORE.get(),
    ...
    private void applyGore(LivingEntity target) {
        ...
        float desiredPostArmor = damageAfterArmor(GORE_DAMAGE, Math.max(0f, armor - 2f), toughness);
