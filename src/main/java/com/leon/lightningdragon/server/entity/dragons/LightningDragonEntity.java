...
public class LightningDragonEntity extends DragonEntity implements FlyingAnimal, RangedAttackMob {
    ...
    // (No action-window gating; GeckoLib controls action playback)
    ...
    // Global sound suppression when staying/sitting (Shift + Right-click command)
    ...
    public void playExcitedSound() {
        if (!level().isClientSide && !isStayOrSitMuted()) {
