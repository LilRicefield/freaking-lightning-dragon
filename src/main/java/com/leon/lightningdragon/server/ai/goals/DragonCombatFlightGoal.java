...
public class DragonCombatFlightGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        if (dragon.stateManager.isFlying() || dragon.stateManager.isLanding()) {
            return false;
        }
    ...
    public void tick() {
        ...
        // Force takeoff using proper flight system integration
        if (flightCheckCooldown <= 0) {
            // Use Leon's proper state management instead of direct manipulation
