...
public class NetworkHandler {
    ...
    public static void register() {
        ...
        // Beam start (mouth) sync from client while beaming
        INSTANCE.registerMessage(id++, MessageBeamStart.class,
                MessageBeamStart::encode,
                MessageBeamStart::decode,
                MessageBeamStart::handle);
