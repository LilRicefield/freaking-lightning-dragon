                ...
                if (vehicle instanceof LightningDragonEntity dragon && dragon.isTame() && dragon.isOwnedBy(player)) {
                    ...
                    switch (msg.action) {
                        ...
                        case STOP_ACCELERATE:
                            ...
                            break;
                        case ABILITY_USE:
                            // Handle ability usage through combat manager
                            if (msg.abilityName != null && !msg.abilityName.isEmpty()) {
                                // Map ability name to ability type
                                if ("bite".equals(msg.abilityName)) {
                                    dragon.useRidingAbility(String.valueOf(com.leon.lightningdragon.common.registry.ModAbilities.BITE));
                                }
                                // Add more ability mappings here as needed
                            }
                            break;
                        case NONE:
                        default:
