...
public class MessageDragonRideInput {
    ...
    public MessageDragonRideInput(boolean goingUp, boolean goingDown, DragonRiderAction action, String abilityName, float forward, float strafe, float yaw) {
    ...
    public MessageDragonRideInput(boolean goingUp, boolean goingDown, String abilityName, float forward, float strafe, float yaw) {
        this(goingUp, goingDown, 
