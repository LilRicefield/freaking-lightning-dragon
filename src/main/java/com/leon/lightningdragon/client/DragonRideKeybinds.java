...
public class DragonRideKeybinds {
    ...
    private static void handleAbilityInput(LightningDragonEntity dragon) {
        ...
        if (lightningBeamHeld != wasLightningBeamPressed) {
            System.out.println("DragonRideKeybinds: Y key state change - held: " + lightningBeamHeld + ", was: " + wasLightningBeamPressed);
        }
        ...
        if (dragon.isFlying()) {
            if (DRAGON_ABILITY_1.consumeClick()) {
                ...
                System.out.println("DragonRideKeybinds: R key pressed - lightning_burst");
            } else if (DRAGON_ABILITY_2.consumeClick()) {
                abilityToUse = "lightning_breath";
                System.out.println("DragonRideKeybinds: T key pressed - lightning_breath");
                ...
                if (dragon.combatManager.getActiveAbility() == null || 
                    ...
                    System.out.println("DragonRideKeybinds: Y key pressed (start beam) - lightning_beam");
                } else {
                    System.out.println("DragonRideKeybinds: Y key pressed but beam already active - ignoring");
                }
            }
        }
        // Ground abilities (only if not flying) - use mouse click
            ...
            if (mc.mouseHandler != null && mc.options.keyAttack.consumeClick()) {
                ...
                System.out.println("DragonRideKeybinds: Left mouse clicked - electric_bite");
            }
        }
        ...
        if (abilityToUse != null) {
            ...
            if (player != null) {
                System.out.println("DragonRideKeybinds: Sending ability packet: " + abilityToUse);
                NetworkHandler.INSTANCE.send(PacketDistributor.SERVER.noArg(),
