...
public class DragonRideKeybinds {
    ...
    public static final KeyMapping DRAGON_CONTINUOUS_LIGHTNING = new KeyMapping(
            "key.lightningdragon.continuous_lightning",
            InputConstants.Type.KEYSYM,
    ...
    public static class ModEventHandler {
        ...
        public static void registerKeys(RegisterKeyMappingsEvent event) {
            ...
            event.register(DRAGON_CONTINUOUS_LIGHTNING);
        }
    }
    ...
    private static void handleDragonControlState(LightningDragonEntity dragon, LocalPlayer player) {
        ...
        // Bit 3: Strike (continuous lightning beam)
        if (DRAGON_CONTINUOUS_LIGHTNING.isDown()) {
            controlState |= 8;
        }
        
        // Bit 4: Dismount (handled by vanilla system already)
    ...
    private static void handleAbilityInput(LightningDragonEntity dragon) {
        ...
        // Check for continuous lightning (both flying and ground)
        boolean continuousLightning = DRAGON_CONTINUOUS_LIGHTNING.isDown();
        ...
        if (dragon.isFlying()) {
            ...
            } else if (continuousLightning) {
                abilityToUse = "continuous_lightning";
            }
        }
