...
/**
 * Enhanced GeoBone with Bob Mowzie's advanced features for dragons
...
public class EnhancedGeoBone extends GeoBone {
    ...
    // ===== ADDITIVE ROTATION METHODS =====
    
    /**
     * Add to X rotation (pitch
     */
