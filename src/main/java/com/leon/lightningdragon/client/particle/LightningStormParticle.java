...
public class LightningStormParticle extends TextureSheetParticle {
    ...
    public static class FactoryArc implements ParticleProvider<com.leon.lightningdragon.common.particle.LightningArcData> {
        private final SpriteSet spriteSet;
        public FactoryArc(SpriteSet spriteSet) { this.spriteSet = spriteSet; }
        @Override
        public Particle createParticle(com.leon.lightningdragon.common.particle.LightningArcData data, ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new LightningStormParticle(world, x, y, z, xSpeed, ySpeed, zSpeed, data.getSize(), spriteSet);
        }
    }
}
