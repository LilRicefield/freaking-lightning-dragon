...
public class DragonRideGoal extends Goal {
    ...
    private void updateBankingFromInput() {
        ...
        float currentBanking = dragon.getBanking();
        float smoothedBanking = DragonMathUtil.approachSmooth(
            currentBanking, dragon.getPrevBanking(), targetBanking, 15.0f, 2.0f
        );
        
        dragon.setPrevBanking(currentBanking);
        dragon.setBanking(smoothedBanking);
    }
