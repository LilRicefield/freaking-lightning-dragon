...
public record DragonRiderController(LightningDragonEntity dragon) {
    ...
    private static final double SPRINT_MAX_MULT = 20.0;   // top speed cap while accelerating
    private static final double AIR_ACCEL_MULT = 0.10;    // accel per tick toward forward while holding W
    private static final double SPRINT_ACCEL_MULT = 0.18; // accel per tick when accelerating
