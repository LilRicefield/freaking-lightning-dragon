...
public class LightningDragonModel extends GeoModel<LightningDragonEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(LightningDragonEntity a) {
        return MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(LightningDragonEntity a) {
        return TEXTURE;
    }

    @Override
    public ResourceLocation getAnimationResource(LightningDragonEntity a) {
        return ANIM;
    }
